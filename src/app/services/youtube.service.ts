...
export class YoutubeService {
  ...
  initAuth() {
    const params = {
      apiKey: 'AIzaSyCLeFbwsg7FRC33M62_AuJq-3CDNb-kQSE',
      clientId: '967219055843-h3527mj1apdtbp2m3hkfu3rhc50dimtj.apps.googleusercontent.com',
...
//   uploadVideo(video: any, input: { title: string, description: string, privacyStatus: string, tags?: string[] }) {
//     if (!this.accessToken) {
//       throw new Error('Authentication is required');
//     }
//     const data = {
